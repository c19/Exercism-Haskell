...
/* package diamond-1.0.0.1 */
#define VERSION_diamond "1.0.0.1"
#define MIN_VERSION_diamond(major1,major2,minor) (\
  (major1) <  1 || \
  (major1) == 1 && (major2) <  0 || \
...
#define CURRENT_COMPONENT_ID "diamond-1.0.0.1-6yr5EVu6sgfGoG4aqYEkSE"

#define CURRENT_PACKAGE_KEY "diamond-1.0.0.1-6yr5EVu6sgfGoG4aqYEkSE"
