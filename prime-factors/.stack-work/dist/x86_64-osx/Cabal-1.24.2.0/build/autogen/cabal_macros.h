...
/* package prime-factors-1.0.0.3 */
#define VERSION_prime_factors "1.0.0.3"
#define MIN_VERSION_prime_factors(major1,major2,minor) (\
  (major1) <  1 || \
  (major1) == 1 && (major2) <  0 || \
...
#define CURRENT_COMPONENT_ID "prime-factors-1.0.0.3-Ep1h3rSsw34JLe6tteDmEj"

#define CURRENT_PACKAGE_KEY "prime-factors-1.0.0.3-Ep1h3rSsw34JLe6tteDmEj"
