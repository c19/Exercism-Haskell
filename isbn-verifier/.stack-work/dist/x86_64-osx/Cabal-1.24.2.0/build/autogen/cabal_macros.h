...
/* package isbn-verifier-1.1.0.1 */
#define VERSION_isbn_verifier "1.1.0.1"
#define MIN_VERSION_isbn_verifier(major1,major2,minor) (\
  (major1) <  1 || \
  (major1) == 1 && (major2) <  1 || \
...
#define CURRENT_COMPONENT_ID "isbn-verifier-1.1.0.1-4knpVDKMCdN6yVDRTVYlC3"

#define CURRENT_PACKAGE_KEY "isbn-verifier-1.1.0.1-4knpVDKMCdN6yVDRTVYlC3"
