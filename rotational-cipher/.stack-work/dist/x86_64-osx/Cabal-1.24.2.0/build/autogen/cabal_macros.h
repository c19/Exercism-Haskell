...
/* package rotational-cipher-1.1.0.1 */
#define VERSION_rotational_cipher "1.1.0.1"
#define MIN_VERSION_rotational_cipher(major1,major2,minor) (\
  (major1) <  1 || \
  (major1) == 1 && (major2) <  1 || \
...
#define CURRENT_COMPONENT_ID "rotational-cipher-1.1.0.1-9go241enq9zGHpA7gJ72tT"

#define CURRENT_PACKAGE_KEY "rotational-cipher-1.1.0.1-9go241enq9zGHpA7gJ72tT"
