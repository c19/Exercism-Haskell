...
/* package run-length-encoding-1.0.0.3 */
#define VERSION_run_length_encoding "1.0.0.3"
#define MIN_VERSION_run_length_encoding(major1,major2,minor) (\
  (major1) <  1 || \
  (major1) == 1 && (major2) <  0 || \
...
#define CURRENT_COMPONENT_ID "run-length-encoding-1.0.0.3-1yhuJkF6HTz7uP47uqEee0"

#define CURRENT_PACKAGE_KEY "run-length-encoding-1.0.0.3-1yhuJkF6HTz7uP47uqEee0"
