...
/* package complex-numbers-1.0.0.1 */
#define VERSION_complex_numbers "1.0.0.1"
#define MIN_VERSION_complex_numbers(major1,major2,minor) (\
  (major1) <  1 || \
  (major1) == 1 && (major2) <  0 || \
...
#define CURRENT_COMPONENT_ID "complex-numbers-1.0.0.1-8JgwOyf8WhxGBuOr0SRUpi"

#define CURRENT_PACKAGE_KEY "complex-numbers-1.0.0.1-8JgwOyf8WhxGBuOr0SRUpi"
