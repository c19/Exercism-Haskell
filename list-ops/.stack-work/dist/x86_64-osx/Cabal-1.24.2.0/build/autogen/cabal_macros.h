...
/* package list-ops-0.1.0.2 */
#define VERSION_list_ops "0.1.0.2"
#define MIN_VERSION_list_ops(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
...
#define CURRENT_COMPONENT_ID "list-ops-0.1.0.2-JKI50BvNEqOLJomxL6kjuW"

#define CURRENT_PACKAGE_KEY "list-ops-0.1.0.2-JKI50BvNEqOLJomxL6kjuW"
