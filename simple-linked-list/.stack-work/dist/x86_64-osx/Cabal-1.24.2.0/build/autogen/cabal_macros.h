...
/* package simple-linked-list-0.1.0.2 */
#define VERSION_simple_linked_list "0.1.0.2"
#define MIN_VERSION_simple_linked_list(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
...
#define CURRENT_COMPONENT_ID "simple-linked-list-0.1.0.2-6wfMmtM7ZAwHZomn5dCWIE"

#define CURRENT_PACKAGE_KEY "simple-linked-list-0.1.0.2-6wfMmtM7ZAwHZomn5dCWIE"
