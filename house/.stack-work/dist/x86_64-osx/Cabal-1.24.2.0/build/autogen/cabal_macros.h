...
/* package house-0.1.0.2 */
#define VERSION_house "0.1.0.2"
#define MIN_VERSION_house(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
...
#define CURRENT_COMPONENT_ID "house-0.1.0.2-HQG49pL7fU9KuPvuj9qRzx"

#define CURRENT_PACKAGE_KEY "house-0.1.0.2-HQG49pL7fU9KuPvuj9qRzx"
