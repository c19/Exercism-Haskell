...
/* package all-your-base-1.0.0.3 */
#define VERSION_all_your_base "1.0.0.3"
#define MIN_VERSION_all_your_base(major1,major2,minor) (\
  (major1) <  1 || \
  (major1) == 1 && (major2) <  0 || \
...
#define CURRENT_COMPONENT_ID "all-your-base-1.0.0.3-4J6PMLg3gePDz1NaM6x524"

#define CURRENT_PACKAGE_KEY "all-your-base-1.0.0.3-4J6PMLg3gePDz1NaM6x524"
