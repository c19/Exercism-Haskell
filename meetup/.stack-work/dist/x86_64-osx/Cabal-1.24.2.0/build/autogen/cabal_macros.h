...
/* package meetup-1.0.0.3 */
#define VERSION_meetup "1.0.0.3"
#define MIN_VERSION_meetup(major1,major2,minor) (\
  (major1) <  1 || \
  (major1) == 1 && (major2) <  0 || \
...
#define CURRENT_COMPONENT_ID "meetup-1.0.0.3-DeZEbl2qIjZjXvuDobyKa"

#define CURRENT_PACKAGE_KEY "meetup-1.0.0.3-DeZEbl2qIjZjXvuDobyKa"
