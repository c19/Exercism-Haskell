...
/* package etl-1.0.0.3 */
#define VERSION_etl "1.0.0.3"
#define MIN_VERSION_etl(major1,major2,minor) (\
  (major1) <  1 || \
  (major1) == 1 && (major2) <  0 || \
...
#define CURRENT_COMPONENT_ID "etl-1.0.0.3-8S1kHbkD5EM5lzMXfkUa3A"

#define CURRENT_PACKAGE_KEY "etl-1.0.0.3-8S1kHbkD5EM5lzMXfkUa3A"
