...
/* package raindrops-1.0.0.3 */
#define VERSION_raindrops "1.0.0.3"
#define MIN_VERSION_raindrops(major1,major2,minor) (\
  (major1) <  1 || \
  (major1) == 1 && (major2) <  0 || \
...
#define CURRENT_COMPONENT_ID "raindrops-1.0.0.3-K9iNzxnbg0cGCEdjNcZAYb"

#define CURRENT_PACKAGE_KEY "raindrops-1.0.0.3-K9iNzxnbg0cGCEdjNcZAYb"
