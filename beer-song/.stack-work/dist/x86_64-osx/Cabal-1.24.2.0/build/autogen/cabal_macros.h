...
/* package beer-song-0.1.0.2 */
#define VERSION_beer_song "0.1.0.2"
#define MIN_VERSION_beer_song(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
...
#define CURRENT_COMPONENT_ID "beer-song-0.1.0.2-EiOPq9esY4I1MClX7gnSFy"

#define CURRENT_PACKAGE_KEY "beer-song-0.1.0.2-EiOPq9esY4I1MClX7gnSFy"
