...
/* package kindergarten-garden-1.0.0.3 */
#define VERSION_kindergarten_garden "1.0.0.3"
#define MIN_VERSION_kindergarten_garden(major1,major2,minor) (\
  (major1) <  1 || \
  (major1) == 1 && (major2) <  0 || \
...
#define CURRENT_COMPONENT_ID "kindergarten-garden-1.0.0.3-65dfosa10uZ4DVhcuLg2Gl"

#define CURRENT_PACKAGE_KEY "kindergarten-garden-1.0.0.3-65dfosa10uZ4DVhcuLg2Gl"
